...
_ROUTES = {
    ...
    "ETypeClass": "etype",
    "ExperimentalBoutonDensity": "experimental-bouton-density",
    "ExperimentalNeuronDensity": "experimental-neuron-density",
    "ExperimentalSynapsesPerConnection": "experimental-synapses-per-connection",
